...
public class StaffSearchDeviceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<form method='post' action='StaffSearchDeviceServlet'>");
        ...
        out.println("</form>");
        out.println("<form method='post' action='staffviewalldevice.jsp'>");
            ...
            Connection con;
                try{
                    ...
                    while(rs.next()){
                        ...
                        out.println("   <td><a href='staffeditdevice.jsp?id=" + rs.getInt("deviceID") + "'>Edit</a>");
                        out.println("       <a href='staffgeneratereceipt.jsp?id=" + rs.getInt("deviceID") + "'>Generate receipt</a></td>");
                        out.println("</tr>");
                    }
                    con.close();
